...
public class YearChooser extends AppCompatActivity {
    ...
    public TextInputLayout helper_year_TextInputLayout;
    ...
    private void initializeUI() {
        ...
        helper_year_TextInputLayout = findViewById(R.id.helper_year_TextInputLayout);
        ...
        button_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (manufacturer == null | model == null | year_spinner.getSelectedItem().toString() == null | editText_VIN.getText().toString().equals("")) {
                    Toast.makeText(YearChooser.this, "Введите год и номер куова!", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(YearChooser.this, AddAutoActivity.class);
